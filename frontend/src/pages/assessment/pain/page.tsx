              ...
              <CardContent className="pt-8 pb-8">
                ...
                >
                  <div className="space-y-3">
                    <div className={`flex items-center space-x-2 border dark:border-slate-800 rounded-lg p-3 transition-all duration-300 dark:hover:text-black  ${selectedPain === "no-pain"
                    ...
                    <div className={`flex items-center space-x-2 border dark:border-slate-800 rounded-lg p-3 transition-all duration-300  dark:hover:text-black  ${selectedPain === "mild"
                          ? "border-pink-500 bg-pink-50 dark:text-black" 
                          : "hover:bg-gray-50"
                        }`}>
                    ...
                    <div className={`flex items-center space-x-2 border dark:border-slate-800 rounded-lg p-3 transition-all duration-300  dark:hover:text-black  ${selectedPain === "moderate"
                          ? "border-pink-500 bg-pink-50 dark:text-black" 
                          : "hover:bg-gray-50"
                        }`}>
                      <RadioGroupItem
                    ...
                    <div className={`flex items-center space-x-2 border dark:border-slate-800 rounded-lg p-3 transition-all duration-300  dark:hover:text-black  ${selectedPain === "severe"
                      ? "border-pink-500 bg-pink-50 dark:text-black" 
                      : "hover:bg-gray-50"
                    }`}>
                      <RadioGroupItem
                    ...
                    <div className={`flex items-center space-x-2 border dark:border-slate-800 rounded-lg p-3 transition-all duration-300  dark:hover:text-black  ${selectedPain === "debilitating"
                          ? "border-pink-500 bg-pink-50 dark:text-black" 
                          : "hover:bg-gray-50"
                        }`}>
                      <RadioGroupItem
                    ...
                    <div className={`flex items-center space-x-2 border dark:border-slate-800 rounded-lg p-3 transition-all duration-300 dark:hover:text-black  ${selectedPain === "varies"
                          ? "border-pink-500 bg-pink-50 dark:text-black" 
                          : "hover:bg-gray-50"
                        }`}>
                      <RadioGroupItem
