...
try {
  ...
  console.log('Updated .env file to remove Azure SQL configuration');
} catch (error) {
...
console.log('Azure SQL cleanup completed!');
console.log('Now the application is configured to use Supabase instead of Azure SQL.');
console.log('Please make sure to set up your Supabase project and add the required environment variables.'); 