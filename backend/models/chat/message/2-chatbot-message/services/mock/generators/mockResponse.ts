...
export const generateMockResponse = async (
  ...
  assessmentData: MockAssessmentData | null = null,
  ...
  try {
    ...
    let category: string;
    let metadata: MockResponseMetadata;
    ...
    const fallbackMetadata: MockResponseMetadata = {
 ...
 * @returns Response content and category
 */
const generateInitialMockResponse = (
  messageText: string,
 ...
 * @returns Response content and category
 */
const generateFollowUpMockResponse = (
  messageText: string,
  conversationHistory: MessageRecord[],
 ...
 * @returns Enhanced mock response
 */
export const generateContextualMockResponse = async (
  messageText: string,
  conversationHistory: MessageRecord[],
  assessmentData: MockAssessmentData | null = null,
  assessmentPattern: string | null = null
  ...
  try {
    ...
    const metadata: MockResponseMetadata = {
      response_category: category,
 ...
 * @returns Assessment-specific mock response
 */
export const generateAssessmentMockResponse = async (assessmentPattern: string): Promise<any> => {
  try {
 ...
 */
const extractTopics = (messages: MessageRecord[]): string[] => {
