...
interface ConversationCreateData {
  ...
  assessment_object?: string | AssessmentObject;
 ...
 * @param assessmentId - Optional assessment ID to link
 * @returns Created conversation ID
 */
export const createConversation = async (
  userId: number | string,
  assessmentId: number | string | null = null
): Promise<string> => {
  try {
    ...
    // Validate it's not just whitespace
