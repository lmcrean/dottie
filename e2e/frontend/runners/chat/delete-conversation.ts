...
export async function deleteConversation(page: Page, state: TestState, conversationId: string): Promise<DeleteConversationResult> {
  try {
    ...
    const deleteButton = page.locator(`[data-testid="delete-conversation-${conversationId}"]`).or(
